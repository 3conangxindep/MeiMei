            ...
            <div className='mt-5'>
                {notification.map((e, index) => (
                    <li
                        ...
                        className={
                            newNotification.some((eNew) => eNew === e)
                                ? 'list-none transition duration-200 cursor-pointer bg-gray-200 hover:bg-gray-200 hover:border hover:border-gray-200 hover:rounded-md'
                                : 'list-none transition duration-200 cursor-pointer hover:bg-gray-200 hover:border hover:border-gray-200 hover:rounded-md'
                        }
                    >
