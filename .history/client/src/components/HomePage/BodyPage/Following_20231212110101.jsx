  ...
  return (
    <div>
      <div className='border-box relative w-full h-screen p-2.5 flex flex-col'>
        {data.map(e => (
          <Link to='/InformationPage' className='list-none transition duration-200 cursor-pointer hover:bg-gray-200 hover:border-gray-200 hover:border hover:rounded-md'>
