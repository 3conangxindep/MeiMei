...
class contactController extends Controller
{
    ...
    public function updateLike($index, $id_card, $contact_id)
    {
        // Find the contacts based on the specified conditions
        $contacts = Contact::where('id_card', $id_card)
            ->where('contact_id', $contact_id)
            ->get();

        // Check if the specified index is within the bounds of the collection
        ...
        // If the index is out of bounds or no matching contact is found
        return response()->json(['error' => 'Contact not found at the specified index'], 404);
    }
