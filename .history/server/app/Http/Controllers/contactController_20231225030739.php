...
class contactController extends Controller
{
    ...
    public function updateLike($id_card, $contact_id)
    {
        ...
        return response()->json(['message' => 'Contact updated successfully', 'like' => $contact->like], 200);
    }
    ...
    public function getFollowing($id_card, $page)
    {
        ...
        $contacts = DB::table('contact')
            ...
            ->select('contact.*', 'user.email', 'contact.created_at as contact_created_at', 'contact.updated_at as contact_updated_at')
