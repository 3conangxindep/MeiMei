    ...
    return (
        <div>
            <div className='border-box relative w-full h-screen p-2.5 flex flex-col'>
                ...
                {data.map((e, index) => (
                    <Link key={e.contact_id} to={`/InformationPage/${id_card}/${e.contact_id}`} className='relative flex items-center w-full h-16 pl-1.5 bg-gray-100 my-1 border rounded-lg border-gray-300 transition duration-200 cursor-pointer hover:bg-gray-200 hover:border-gray-200 hover:border hover:rounded-lg'>
                        {/* {setIsSaved(e.like)} */}
                        {/* item-container */}
