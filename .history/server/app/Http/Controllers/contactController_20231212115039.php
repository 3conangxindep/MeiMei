...
class contactController extends Controller
{
    ...
    public function update(Request $request, $id_card, $contact_id)
    {
        ...
        if (!$existingContact) {
            ...
            $existingContact->update([
                // Add the attributes you want to update
                // Example: 'attribute_name' => $request->input('attribute_name'),
            ]);
        }
    ...
    public function getFollowingContacts($id_card, $page)
    {
        ...
        return response()->json(['data' => $contacts, 'totalPages' => $totalPages, 'created_at'], 200);
    }
