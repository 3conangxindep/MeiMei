        ...
        <div className='relative w-full h-20 px-4 border-box'>
            ...
            <div className='flex items-center justify-between w-full h-full'>
                ...
                <div className='p-2.5 flex justify-center items-center'>
                    ...
                    {/* notification */}
                    <div className='absolute w-5 h-5 rounded-full border border-solid border-gray-500 flex justify-center items-center bg-red-500 text-white top-3 right-14'>1</div>
